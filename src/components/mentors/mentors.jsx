    ...
    (<>
      <div>
        <h1 className="text-center text-5xl text-white font-bold mt-16 ">
          Meet The<span className="text-purple-600"> Mentors</span></h1>
        <p className="text-xl text-center text-white font-semibold mt-6">The mentors who will guide and help you through the entire Coding Process</p>
      </div>
