    ...
    (<>
      <div>
        <h1 className="text-center text-5xl text-white font-bold mt-16 ">
          Meet Our<span className="text-purple-600"> Judges</span></h1>
        <p className="text-xl text-center text-white font-semibold mt-6">Industry experts who will evaluate your innovative solutions</p>
      </div>
