        ...
        <div className="grid grid-cols-1 lg:divide-x-2 lg:grid-cols-2 gap-6 items-center lg:space-x-3">
          <div className=" flex flex-col ">
            <h2 className="text-4xl sm:text-5xl lg:text-5xl font-bold tracking-tight">
              ...
              <span className="block font-sans font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#5C24FF] to-[#D94FD5]">HACKATHON</span>
            </h2>
            <img src={Logo} alt="Not Found" className="w-[300px] ml-36 -mt-12"></img>
            <button className="btn-4 ml-40 -mt-12 bg-purple-700 text-white">Join Our Discord</button>
          </div>
